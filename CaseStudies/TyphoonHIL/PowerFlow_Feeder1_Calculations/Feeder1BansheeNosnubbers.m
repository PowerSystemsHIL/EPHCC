function mpc = Feeder1BansheeNosnubbers
...
% coupling.  Impedance from core coupling and snubbers ARE NOT considered. Shunt
...
mpc.bus = [
	...
	2	1	0	0	0.0152	0.00	1	1	0	13.8	1	1.10	0.90; %Pd is the shunt loss of the Measurements
	...
	10	1	0	0	0.0076	0.00	1	1	0	13.8	1	1.10	0.90; %Pd is the sum of the shunt loss of Trafo and Measurements
	...
	15	1	0	0	0.04381	0.00	1	1	0	13.8	1	1.10	0.90; %Pd is the shunt loss of the Measurements
	16	2	0	0	0.04	0.00	1	1	0	13.8	1	1.10	0.90; %Pd is the shunt loss of the Genset Measurements and Dummy load
	17	1	0	0	0.0095	0.00	1	1	0	13.8	1	1.10	0.90; %Pd is the resistive shunt loss of the trafo and the Measurements
	18	1	0	0	4.6e-6	0.00	1	1	0	0.48	1	1.10	0.90; %Pd is the shunt loss of the Measurements
