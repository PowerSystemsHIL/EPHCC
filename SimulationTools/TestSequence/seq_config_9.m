...
Next('Fault.Gen2', 5, 1);
Next('Fault.Gen2', 7, 0);
Next('Fault.Ess2', 29, 1);
Next('Fault.Ess2', 30.5, 0);
Next('Fault.Pv1', 39, 1);
Next('Fault.Pv1', 40, 0);
Next('Fault.Gen3', 48.5, 1);
Next('Fault.Gen3', 50, 0);
Next('Fault.Gen1', 73, 1);
Next('Fault.Gen1', 74.5, 0);
Next('Fault.Ess1', 86, 1);
Next('Fault.Ess1', 88, 0);
Next('Fault.Pv2', 95, 1);
Next('Fault.Pv2', 97, 0);
...
Next('DMS.PFena', 1, 1);
Next('DMS.PFref', 1, 0.98);       
Next('DMS.kWena', 4, 1);
Next('DMS.kWref', 4, 8000);         % DMS xport request
Next('DMS.kWref', 6, 7000);         % DMS xport request
Next('DMS.kWref', 8, 6000);         % DMS xport request
