...
subplot(5,1,1); plot(seq.t, [seq.irradiance; seq.price]);
subplot(5,1,2); plot(seq.t, [seq.dms_kWref_nan+0.02*10e3; ...
                             seq.dms_kWref_nan-0.02*10e3; ...
                             seq.dms_kWref_nan+(0.02+1./seq.dms_Dp)*10e3; ...
                             seq.dms_kWref_nan-(0.02+1./seq.dms_Dp)*10e3; ...
                             ]);
subplot(5,1,3); plot(seq.t, [seq.dms_phiref_nan+5; ...
...
subplot(5,1,[4 5]); plot(seq.t, dig + base);
