...
ax= subplot(3,4,1); plot(res.simtime(:,1), res.powerreal(:,[16:34]));
ax= [ax subplot(3,4,5)]; plot(res.simtime(:,1), res.powerreal(:,[52]));
ax= [ax subplot(3,4,9)]; plot(res.simtime(:,1), res.powerreal(:,[55]));

ax= [ax subplot(3,4,2)]; plot(res.simtime(:,1), res.reactivepower(:,[16:34]));
ax= [ax subplot(3,4,6)]; plot(res.simtime(:,1), res.reactivepower(:,[52]));
ax= [ax subplot(3,4,10)]; plot(res.simtime(:,1), res.reactivepower(:,[55]));

ax= [ax subplot(3,4,3)]; plot(res.simtime(:,1), res.voltage(:,[16:34]));
ax= [ax subplot(3,4,7)]; plot(res.simtime(:,1), res.voltage(:,[52]));
ax= [ax subplot(3,4,11)]; plot(res.simtime(:,1), res.voltage(:,[55]));

ax= [ax subplot(3,4,4)]; plot(res.simtime(:,1), res.breaker(:,[16:34]));
ax= [ax subplot(3,4,8)]; plot(res.simtime(:,1), res.breaker(:,[52]));
ax= [ax subplot(3,4,12)]; plot(res.simtime(:,1), res.breaker(:,[55]));
