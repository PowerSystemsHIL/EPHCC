...
paramPLLQFEDebounceTime = 4; % Falling debounce time - time to go out of sync - let high time for ridethrough
paramPLLQREDebounceTime = 0.5; % Rising debounce time - time to go sync
sampdT = Tc;
dT = Ts;
